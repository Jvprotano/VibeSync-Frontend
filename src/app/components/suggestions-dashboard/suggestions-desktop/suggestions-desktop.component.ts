...
@Component({
  selector: 'app-suggestions-desktop',
  templateUrl: './suggestions-desktop.component.html',
  styleUrl: './suggestions-desktop.component.scss',
  standalone: false
})
export class SuggestionsDesktopComponent implements OnInit {
